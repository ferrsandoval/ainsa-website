...
interface ProductsDetailSectionProps {
  onNavigate?: (page: string) => void;
}

export function ProductsDetailSection({ onNavigate }: ProductsDetailSectionProps) {
  const productCategories = [
    {
      title: "Acero Inoxidable",
      subtitle: "Resistencia, durabilidad y acabado impecable",
      icon: "🔹",
      route: "aceros-inoxidables",
      items: [
    ...
    },
    {
      ...
      icon: "🔹",
      route: "aceros-carbones-especiales",
      items: [
