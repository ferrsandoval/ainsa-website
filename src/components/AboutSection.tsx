...
export function AboutSection() {
  return (
    <section id="nosotros" className="py-32 bg-ainsa-white dark:bg-ainsa-black">
      <div className="container mx-auto px-6 lg:px-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-20 items-center mb-32">
          ...
          <div className="lg:col-span-7">
            <span className="text-sm tracking-wider text-ainsa-gray uppercase mb-4 block">
              ACERCA DE AINSA
            </span>
            <h2 className="text-4xl md:text-5xl lg:text-6xl leading-tight mb-8">
              Aliados Estratégicos para la Industria
            </h2>
            <p className="text-lg text-ainsa-gray leading-relaxed mb-6">
            ...
            <div className="space-y-4 mb-8">
              <div className="flex items-start space-x-3">
                ...
                <p className="text-lg text-ainsa-gray leading-relaxed">
            ...
            <p className="text-lg text-ainsa-gray leading-relaxed mb-8 font-medium">
            ...
            <div className="flex items-center space-x-4 mb-12">
              <div className="w-12 h-12 bg-ainsa-red rounded-full flex items-center justify-center">
                <span className="text-white">A</span>
              </div>
              <div>
                <p className="text-sm text-ainsa-gray">FUNDADOR & CEO</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-16">
          <div className="text-center">
            ...
            <p className="text-sm text-ainsa-gray uppercase tracking-wider">Años de Experiencia</p>
            <p className="text-ainsa-gray mt-2 text-sm leading-relaxed">
          ...
          <div className="text-center">
            ...
            <p className="text-sm text-ainsa-gray uppercase tracking-wider">Proyectos Completados</p>
            <p className="text-ainsa-gray mt-2 text-sm leading-relaxed">
          ...
          <div className="text-center">
            ...
            <p className="text-sm text-ainsa-gray uppercase tracking-wider">Certificación de Calidad</p>
            <p className="text-ainsa-gray mt-2 text-sm leading-relaxed">
