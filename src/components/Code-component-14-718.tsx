      ...
      <div className="container mx-auto px-6 lg:px-12">
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <h2 
              className="text-4xl lg:text-5xl xl:text-6xl leading-tight tracking-tight text-foreground"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <motion.div 
              ...
              viewport={{ once: true }}
              className="bg-background rounded-2xl p-8 lg:p-10 shadow-sm border border-border/30"
            >
              <div className="mb-6">
