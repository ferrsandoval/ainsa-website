...
export const seoConfigs: Record<string, SEOConfig> = {
  ...
  '404': {
    title: 'Página no encontrada | AINSA Acero Inoxidable',
    description: 'La página que buscas no existe. Explora nuestro catálogo de acero inoxidable, aluminio y materias primas industriales en AINSA.',
    keywords: 'página no encontrada, error 404, AINSA, acero inoxidable, materias primas, catálogo productos',
    canonical: `${baseUrl}/404`,
    jsonLd: {
      "@context": "https://schema.org",
      "@type": "WebPage",
      "name": "Página no encontrada - AINSA",
      "description": "Página de error 404 con enlaces útiles",
      "mainEntity": organizationJsonLd
    }
  }
};
